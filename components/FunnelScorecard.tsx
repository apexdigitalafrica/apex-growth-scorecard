        ...
        <div className="relative z-10 p-6 sm:p-8 lg:p-10">
          ...
          <div className="flex flex-wrap items-start justify-between gap-4 mb-8">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button className="group flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-cyan-600 hover:from-emerald-500 hover:to-cyan-500 px-4 py-2.5 rounded-xl text-sm font-bold text-white transition-all hover:scale-105 shadow-lg shadow-emerald-500/25">
            ...
            <div className="xl:col-span-5 space-y-6">
              ...
              <div className="relative overflow-hidden rounded-2xl border-2 border-cyan-500/30 bg-gradient-to-br from-cyan-950/40 to-blue-950/40 p-6">
                ...
                <div className="relative">
                  ...
                  <button className="group w-full flex items-center justify-center gap-2 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-bold py-3 px-6 rounded-xl transition-all hover:scale-105 shadow-lg shadow-cyan-500/25">
